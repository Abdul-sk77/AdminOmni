...
<div class="content-wrapper" style="zoom:90%">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-dark">Feedback</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="container mb-3">
        <div class="row">
            <div class="btn-group col-sm-3" role="group" aria-label="forth group">
                <select id="store_id" multiple data-style="bg-whitesmoke " class="selectpicker w-99" title="Select Store id*">
                    <?php
            ...
            <div class="btn-group  mr-3 px-2" role="group" aria-label="forth group">
                <button type="button" onclick ="expotExcelFeedback();"class="btn btn-outline-info btn-lg" style="padding: 0px 50px;">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body table-responsive">
                <table id="feedback_table" class="table table-striped table-bordered mydatatable bg-light " style="width:100%">
                    <thead>
                    <tr>
    ...
    //   "ordering":false,
      ...
      aoColumns: [
          ...
          { mData: 'store_id',width:"10%" },
            { mData: 'emp_id',width:"10%"},
            { mData: 'first_name',width:"11%" },
            { mData: 'last_name',width:"11%" },
            { mData: 'email',width:"15%" },
            { mData: 'rating',width:"7%" },
...
function expotExcelFeedback(){
    var searchValue = $('.dataTables_filter input').val();
    window.location ="<?php echo base_url('index.php/admin/export-feedback'); ?>?searchValue="+searchValue;  
}
</script>