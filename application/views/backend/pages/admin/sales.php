    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                <button type="button" onclick="expotExcelSale();" class="btn btn-outline-info btn-lg" style="padding: 0px 70px; float:right;">
...
<script>
    ...
    function submitFilter(){
        ...
        function expotExcelSale(){
        var searchValue = $('.dataTables_filter input').val();
        window.location ="<?php echo base_url('index.php/admin/export-sales'); ?>?searchValue="+searchValue;  
    }
</script>