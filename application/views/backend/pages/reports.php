        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <button type="button" onclick="expotExcelSmReports();" class="btn btn-outline-info btn-lg" style="padding: 0px 70px; float:right;">
...
<script>
    $(document).ready(function (){
        ...
        var orderDetailsTable = $("#order_details_table").dataTable({
            ...
            // "scrollX": true,
            ajax:{
            url:  "<?php echo base_url('index.php/sm/reports/get-reports-order-griddata'); ?>",
            type: "POST",
            data:function(data){ 
    ...
    function submitFilter(){
        ...
        function expotExcelSmReports(){
        var searchValue = $('.dataTables_filter input').val();
        window.location ="<?php echo base_url('index.php/sm/export-report'); ?>?searchValue="+searchValue;  
    }
</script>